...
#         Version:  1.9
#     Modified by: Chris Hewinson(Chewy)
###
...
LOGO="/private/var/tmp/logo-rings.png"
...
PROMPT_MESSAGE="Your Mac's FileVault encryption key needs to be escrowed by Simple IT. Feel free to open an issue in Freshdesk if you have any questions.
...
Please submit an issue to it/help in GitHub for help with your Mac password."
...
FAIL_MESSAGE="Sorry, an error occurred while escrowing your FileVault key. Please submit an issue in Freshdesk for help."
